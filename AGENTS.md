...
Use the Moxie Docs MCP server before editing CassieMarie0728/snippet-bubble-manager-v2. Load conventions, documentation patterns, documentation gaps, documentation update opportunities, and verified commands before changing code.

When your Moxie Docs token serves more than one repository, pass `repository: "CassieMarie0728/snippet-bubble-manager-v2"` in every Moxie tool call from this repo so the context targets CassieMarie0728/snippet-bubble-manager-v2.
